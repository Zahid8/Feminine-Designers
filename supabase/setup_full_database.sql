-- Feminine Designer full Supabase setup
-- Run this once in Supabase SQL Editor for a new empty Supabase project.
-- Generated from migrations and seed files.
...
-- Migration 002: order save RPC and cloth sample
alter table orders
...
-- Migration 003: settings-driven garments and templates
