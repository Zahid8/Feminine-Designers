...
import { canTransitionStatus, isPastOrderForList, nextAllowedStatuses } from "@/lib/calculations/status";
...
describe("status workflow", () => {
  ...
  it("classifies delivered, cancelled, and past-delivery orders as past list orders", () => {
    expect(isPastOrderForList({ status: "Delivered", deliveryDate: "2026-07-05" }, "2026-07-01")).toBe(true);
    expect(isPastOrderForList({ status: "Cancelled", deliveryDate: "2026-07-05" }, "2026-07-01")).toBe(true);
